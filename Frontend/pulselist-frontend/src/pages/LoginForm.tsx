...
function LoginForm() {
    ...
    const {mutate, isPending, isError, error} = useMutation({
        ...
        mutationFn: async () => {
            ...
            const res = await axios.post(import.meta.env.VITE_PULSELIST_ADDUSERURL,
                {                    
                    username: username,
        ...
        <>
            <div className="login-form">
                ...
                <form onSubmit={handleSubmit}> 
                    ...
                    <button type="submit" disabled={isPending}>{isPending ? "Registering user... Please wait!" : "Sign Up!"}</button>
